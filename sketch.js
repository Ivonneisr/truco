...
if(gameState==1){
  ...
  fill("white");
  text("Colecta los dulces con el puntero del mouse.",displayWidth/6,displayHeight/4+50);
  text("Ciudado con los fantasmas!! El juego terminará si los tocas. ",displayWidth/2-400,displayHeight/4+120);
  text("presiona 'Enter' para empezar el juego... ",displayWidth/2-300,displayHeight/2);
  textSize(60)
  text("Feliz Halloween y día de muertos",displayWidth/2,displayHeight-200);
...
if(gameState==3){
  ...
  text("presiona 'Enter' para reiniciar el juego",displayWidth/4,50);
